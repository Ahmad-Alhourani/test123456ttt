...
trait PlayerAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.player.destroy', $this) .
            '"
			 data-method="delete"
     ...
     * @return  string
     */
    public function getInventorysButtonAttribute()
    {
        return '<a href="' .
            route('admin.inventory.player', $this) .
            ' " class="dropdown-item">' .
            __('Inventorys') .
            '</a> ';
    }
