...
trait InventoryAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.inventory.show', $this) .
    ...
    {
        return '<a href="' .
            route('admin.inventory.edit', $this) .
            '" data-toggle="tooltip" data-placement="top" title="' .
    ...
    {
        return '<a href="' .
            route('admin.inventory.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" inventory="group" aria-label="Inventory Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
